...
tags: [AI Memory, Long Term Memory, Hybrid vector-graph layer, Graph completion retriever, Multi-hop reasoning, Temporal session management]
dependencies: [cognee==0.5.1]
---
